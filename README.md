...
[Watch the fully rendered Blender animation](output/machina-cordis-closeup.mp4).

The 4.5-second close-up uses the real scene materials and animation at 720×720, 24 fps. A tracked camera makes a subtle orbit while the chambers, iris valves, crank train, telemetry crown, gauges, fluid system, and diagnostic display animate.
